 ...
 */
export function LocationRosterActivosChip({ isBautizos, activeCount, rosterSearchActive, filteredCount }) {
  return (
    <>
      <span
        ...
        title={
          isBautizos
            ? 'Activos inscritos en esta sede (titulares + acompañantes canónicos).'
            : `Activos inscritos en esta sede (${activeCount}).`
        }
      >
        {activeCount}
      </span>
